...
if(!file.exists('./data/images/pre-process.Rdata')){
  ...
  dir.create('./data/images/', showWarnings = F)
  save.image('./data/images/pre-process.Rdata')
}else{
  load('./data/images/pre-process.Rdata')
}
